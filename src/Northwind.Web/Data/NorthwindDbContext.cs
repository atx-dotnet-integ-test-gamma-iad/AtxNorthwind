...
public class NorthwindDbContext : DbContext
{
    ...
    {
        // --- Table mappings: PostgreSQL schema and lowercase table names ---
        ...
        // --- Bool conversions: PostgreSQL requires explicit int conversion for bool ---

        modelBuilder.Entity<Product>()
            .Property(e => e.Discontinued)
            .HasConversion<int>();

        // --- Relationships (preserved exactly as original) ---
