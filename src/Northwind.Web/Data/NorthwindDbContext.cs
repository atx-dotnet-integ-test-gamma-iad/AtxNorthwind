...
public class NorthwindDbContext : DbContext
{
    ...
    {
        // -------------------------------------------------------
        // Table-to-schema mappings (PostgreSQL: northwind_dbo)
        // -------------------------------------------------------
        ...
        // -------------------------------------------------------
        // Customer: schema mapping + relationships
        // -------------------------------------------------------
        ...
        // -------------------------------------------------------
        // Product: schema mapping + bool conversion + relationships
        // -------------------------------------------------------
        ...
        // -------------------------------------------------------
        // OrderDetail: schema mapping + composite key + relationships
        // -------------------------------------------------------
