...
{
    // Npgsql legacy timestamp behavior: treat DateTime as UTC (matches SQL Server DATETIME semantics)
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            // No schema mapping returned for Products — table/column names are handled via entity attributes
            // Bool conversion: Discontinued maps to integer (0/1) in PostgreSQL
